...
writeShellScript "${n}-run" ''
  ...
  ${{
    "process" = "exec ${nglib.maybeChangeUserAndGroup s.user s.group s.supplementaryGroups s.execStart}";
    "scripted" = "${nglib.maybeChangeUserAndGroup s.user s.group s.supplementaryGroups s.execStart} ; sleep infinity";
  }.${s.type}}
''
