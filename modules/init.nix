  ...
  config = {
    ...
    assertions = lib.flatten (
      lib.mapAttrsToList (n: v: [
        ...
        {
          assertion = v.user == null || config.dinit.enable;
          message = "init.service.<name>.user is currently only implemented for Dinit.";
        }
        {
          assertion = v.group == null || config.dinit.enable;
          message = "init.service.<name>.group is currently only implemented for Dinit.";
        }
        {
